    ...
    children: [
      {
        path: 'list',
        name: 'ProductList',
        component: () => import('@/pages/product/List'),//函数方法简写 src=@
    ...
    children: [
      {
        path: 'list',
        name: 'ColumnList',
        component: () => import('@/pages/category/List'),//函数方法简写 src=@
    ...
    children: [
      {
        path: 'list',
        name: 'OrderList',
        component: () => import('@/pages/order/List'),//函数方法简写 src=@
    ...
    children: [
      {
        path: 'list',
        name: 'CommentList',
        component: () => import('@/pages/comment/List'),//函数方法简写 src=@
    ...
    children: [
      {
        path: 'list',
        name: 'AddressList',
        component: () => import('@/pages/address/List'),//函数方法简写 src=@
